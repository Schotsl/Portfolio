<template>
  <div class="privacy">
    <h1>Privacy policy for Sjors van Holst</h1>
    <p>
      At Sjors van Holst, accessible from
      <a href="https://sjorsvanholst.nl">sjorsvanholst.nl</a>, one of our main
      priorities is the privacy of our visitors. This privacy policy document
      contains types of information that is collected and recorded by Sjors van
      Holst and how we use it.
    </p>
    <p>
      If you have additional questions or require more information about our
      privacy policy, do not hesitate to
      <a href="mailto:sjorsvanholst@gmail.com">contact</a> us.
    </p>
    <p>
      This privacy policy applies only to our online activities and is valid for
      visitors to our website with regards to the information that they shared
      and/or collect in Sjors van Holst. This policy is not applicable to any
    ...
    <p>
      If you <a href="mailto:sjorsvanholst@gmail.com">contact</a> us directly,
    ...
    <p>
      ...
      <a href="mailto:sjorsvanholst@gmail.com">contact</a> information,
    ...
    <h2>Log Files</h2>
    <p>
      Sjors van Holst follows a standard procedure of using log files. These
    ...
    <p>
      ...
      advertising partners of Sjors van Holst.
    </p>
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Sjors van Holst, which are sent
    ...
    <p>
      Note that Sjors van Holst has no access to or control over these cookies
    ...
    <p>
      Sjors van Holst's privacy policy does not apply to other advertisers or
    ...
    <ul>
      ...
      <li>
        ...
        we correct any information you believe is inaccurate. You also have the
    ...
    <p>
      Sjors van Holst does not knowingly collect any Personal Identifiable
      Information from children under the age of 13. If you think that your
      child provided this kind of information on our website, we strongly
      encourage you to <a href="mailto:sjorsvanholst@gmail.com">contact</a> us
...
export default class Privacy extends Vue {
  mounted(): void {
    document.title = `Privacy policy | Sjors van Holst`;
  }
}
</script>
